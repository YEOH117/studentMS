    ...
    f.prototype = {
        constructor: f, init: function (e) {
            ...
            var e = this, i = "", t = e.initialPreview, a = e.initialPreviewCount, n = e.initialCaption.length,
                r = "preview-" + u(), l = n > 0 ? e.initialCaption : e.msgSelected.replace(/\{n\}/g, a);
            if (c(t) && a > 0) {
            ...
            var a = this, n = w.createObjectURL(i), r = e("#" + t),
            ...
            var a, n, r = this, l = r.parseFileType(e), p = e.name, c = r.allowedPreviewTypes,
                m = r.allowedPreviewMimeTypes, g = (e.type, v(l, r.previewTemplates) ? r.previewTemplates[l] : o[l]),
                f = v(l, r.previewSettings) ? r.previewSettings[l] : s[l], h = parseInt(r.wrapTextLength),
                b = r.wrapIndicator, y = r.$preview, C = c.indexOf(l) >= 0, $ = d(m) || !d(m) && v(e.type, m);
            if (C && $) {
                if ("text" == l) {
                    var x = i.target.result;
                    if (w.revokeObjectURL(a), x.length > h) {
                        var T = "text-" + u(), F = .75 * window.innerHeight,
            ...
            var t = this, a = t.$element, n = t.$preview, r = t.reader, l = t.$previewContainer, o = t.$previewStatus,
                s = t.msgLoading, d = t.msgProgress,
                c = (t.msgSelected, t.previewFileType, parseInt(t.wrapTextLength), t.wrapIndicator, "preview-" + u()),
                m = e.length, g = v("text", t.fileTypeSettings) ? t.fileTypeSettings.text : p.text;
            i(0)
        }, change: function (e) {
            var i, t = this, a = t.$element, n = a.val().replace(/\\/g, "/").replace(/.*\//, ""), r = 0, l = t.$preview,
                o = a.get(0).files, s = t.msgSelected, p = d(o) ? 1 : o.length + t.initialPreviewCount;
            ...
            var e = this, i = e.showPreview ? e.getLayoutTemplate("preview").replace(/\{class\}/g, e.previewClass) : "",
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超出了允许的最大上传大小 <b>{maxSize} KB</b>. 请您重新上传!',
        msgFilesTooMany: "上传文件 <b>({n})</b> 的数量超过了允许的最大限制 <b>{m}</b>. 请您重新上传!",
        msgFileNotFound: '找不到 "{name}" 文件!',
        msgFileNotReadable: '文件 "{name}" 不可读.',
        msgFilePreviewAborted: '文件预览出错 "{name}".',
        ...
        msgErrorClass: "文件错误信息",
        msgLoading: "加载文件 {index} - {files} &hellip;",
        msgProgress: "加载文件 {index} - {files} - {name} - 已完成{percent}%.",
        msgSelected: "{n} 文件已选择",
