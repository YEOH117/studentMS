                    ...
                    <div class="panel panel-default">
                        ...
                        <script>
                            function yes_confirm() {
                                ...
                                if (r==true)
                                {
                                    window.location.href="{{ route('adjust_process_none',[$moveStudent,$token,1]) }}";
                                }
                            }
                            function no_confirm() {
                                ...
                                if (r==true)
                                {
                                    window.location.href="{{ route('adjust_process_none',[$moveStudent,$token,0]) }}";
                                }
                            }
                        </script>
                    </div>
